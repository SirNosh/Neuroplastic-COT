...
def parse_args():
    parser = argparse.ArgumentParser(description="Standard fine-tuning for Qwen2.5-7B (no neuroplasticity)")
    ...
    parser.add_argument("--output_dir", type=str, default="./output_standard", help="Output directory")
    ...
    parser.add_argument("--wandb_project", type=str, default="cot-standard", help="W&B project name")
...
def setup_wandb(args):
    ...
    if args.use_wandb:
        wandb.init(
            ...
            config=vars(args),
            name=f"qwen2.5-3b-cot-standard",
        )
...
def train(args):
    ...
    logger.info("Training with standard fine-tuning (no neuroplasticity mechanisms)")
